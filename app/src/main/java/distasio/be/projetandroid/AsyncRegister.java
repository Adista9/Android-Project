...
public class AsyncRegister extends AsyncTask<String, Void , String> {
    ...
    public AsyncRegister(LoginActivity s) {
        screen = s;
    }
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            URL url = new URL("http://androidskurt.16mb.com/RPC/creer_compte.php?pseudo=" + params[0] + "&mdp=" + params[1]);
    ...
    protected void onPostExecute(String result) {
        ...
        screen.populateRegister(result);
    }
}
